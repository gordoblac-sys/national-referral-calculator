...
ss_brand_copy, ss_brand_shield = st.columns([5, 1])

with ss_brand_copy:
    st.markdown(
        """
        <section class="ss-emblem-banner">
            <div class="ss-emblem-copy">
                <div class="ss-emblem-label">
                    🛡️ SafeStreets
                </div>

                <h2 class="ss-emblem-title">
                    National Referral Calculator
                </h2>

                <p class="ss-emblem-subtitle">
                    Protection built with confidence,
                    accuracy, and a five-star customer
                    experience.
                </p>
...
with ss_brand_shield:
    st.image(
        "assets/safestreets-shield.png",
        width=150,
    )
# SAFESTREETS_EMBLEM_END
